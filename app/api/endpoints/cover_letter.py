...
from app.services.openai_agents_service import generate_cover_letter
...
async def generate_cover_letter_endpoint(
    ...
    """
    Generate a cover letter based on a resume and job description using OpenAI's AI models.
