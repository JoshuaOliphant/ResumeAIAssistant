...
class ResumeRepository(BaseRepository[Resume, ResumeCreate, ResumeUpdate]):
    ...
    def get_by_user(self, user_id: str, skip: int = 0, limit: int = 100) -> List[Resume]:
        """
    ...
    def create_version(self, resume_id: str, version_in: ResumeVersionCreate) -> ResumeVersion:
        """
